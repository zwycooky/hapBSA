...
RUN pip install --user whatshap -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
...
ENV PATH=$PATH:/hapBSA/scripts/:/samtools-1.17/:/gatk-4.4.0.0/:/bwa/:/hisat2-2.2.1/:/root/.local/bin/
